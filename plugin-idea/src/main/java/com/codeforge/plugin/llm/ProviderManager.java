package com.codeforge.plugin.llm;

import com.codeforge.plugin.llm.provider.LlmProvider;
import com.codeforge.plugin.llm.provider.ProviderRegistry;
import com.codeforge.plugin.llm.provider.ProviderRegistry.ProviderMeta;
import com.codeforge.plugin.llm.provider.impl.DeepSeekProvider;
import com.codeforge.plugin.llm.provider.impl.GenericOpenAIProvider;
import com.codeforge.plugin.llm.provider.impl.MiniMaxProvider;
...
public class ProviderManager {
     ...
     * 单个提供商的配置信息
     * <p>
     * 由 Kotlin 层的 CodeForgeSettings 传入，简化版本（公开字段，无 Lombok）。
     */
